...
* 📄 [Ver Script SQL desta atividade](./atividade_04/Exercicio_1_Biblioteca_Escolar.sq)
...
* 📄 [Ver Script SQL desta atividade](./atividade_08/Exercicio_2_Compra_Online.sql
)
